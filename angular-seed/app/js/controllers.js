...
myAppControllers.controller('WidgetController', ['$window', '$scope', 'autoSuggestService',
	function($window, $scope, autoSuggestService) {
		...
		$scope.searchBang = function(qString) {
			...
			// head off to SERP
			$window.location.href = 'http://m.att.com/mobilesearch/search-results.html?m_search=' + qString;
		};
	}
]);
