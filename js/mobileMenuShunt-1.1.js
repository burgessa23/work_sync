...
var ATTMobileMenuShunt = (function ($) {
	...
	shuntMenuContents = function (htmlString) {
		...
		if ($('div[data-role="page"]').length > 1) {
			$('div[data-role="page"]:first').prepend('<div id="outerMMW" style="height:0px;oveflow:scroll;display:none;"><div id="menuMainSlider"><div class="menuWedge"></div><div id="menuWrapper"></div></div></div>');
		} else {
			$('div[data-role="page"]').prepend('<div id="outerMMW" style="height:0px;oveflow:scroll;display:none;"><div id="menuMainSlider"><div class="menuWedge"></div><div id="menuWrapper"></div></div></div>');
		}
		...
		$('.toggleMenuMain').toggle(function () {
			$('#iconMenu').html('[Menu Open]');
			$('#outerMMW').show();
			$("#menuMainSlider").animate({right: "0px" }, 300, function () {});
			$('div[data-role="page"]').animate({left: "-270px" }, 300, function () {}).click(closeMobileSlideMenu);
...
var ATTMobileSearchWidget = (function ($) {
	...
	runSearch = function (s_val, source) {
		...
		if (searchTerm !== '') {
			...
			if (navigator.userAgent.indexOf('iPhone') !== -1) {
				//$('#subSearch').find("input[type=text], textarea").val("");
			}
			if (typeof searchSilo !== 'undefined') {
				if (typeof homePageMarker !== 'undefined') {
					window.location = ATTMobileMenuShunt.getMenuItemURLHostName('json') + '/mobilesearch/search-results.html?m_search=' + encodeURIComponent(searchTerm) + '&m_silo=' + searchSilo + searchSource + '&m_source=' + homePageMarker;
				} else {
					window.location = ATTMobileMenuShunt.getMenuItemURLHostName('json') + '/mobilesearch/search-results.html?m_search=' + encodeURIComponent(searchTerm) + '&m_silo=' + searchSilo + searchSource;
				}
			} else {
				if (typeof homePageMarker !== 'undefined' && homePageMarker !== '') {
					window.location = ATTMobileMenuShunt.getMenuItemURLHostName('json') + '/mobilesearch/search-results.html?m_search=' + encodeURIComponent(searchTerm) + searchSource + '&m_source=' + homePageMarker;
				} else {
					if (window.location.href.indexOf('/myatt/') !== -1) {
						window.location = ATTMobileMenuShunt.getMenuItemURLHostName('json') + '/mobilesearch/search-results.html?m_search=' + encodeURIComponent(searchTerm) + '&m_silo=myatt' +  searchSource;
					} else {
						window.location = ATTMobileMenuShunt.getMenuItemURLHostName('json') + '/mobilesearch/search-results.html?m_search=' + encodeURIComponent(searchTerm) + searchSource;
					}
				}
			}
		} else {
	...
	clearSearchFieldValues = function () {
		...
		$('#clearSearchText').click(function (e) {
			e.preventDefault();
			element.val('');
	...
	injectSearchWidgetHarness = function () {
		...
		// string reps. of widget
			widgetBasic = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div id="resultsSearch" class="searchWidget" style="background-color: #f2f2f2;"><form class="searchForm"  style="background-color: #f2f2f2;" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true"  data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div>',
			widgetBasicNoBg = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div id="resultsSearch" class="searchWidget"><form class="searchForm" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true" data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div>',
			widgetThickBorder = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div id="resultsSearch" class="searchWidget dividerBefore" style="background-color: #f2f2f2;"><form class="searchForm" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true" data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div>',
			widgetThinBorder = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div style="border-bottom: 1px solid #DADADA;" id="resultsSearch" class="searchWidget"><form class="searchForm" style="background: #F2F2F2;" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true" data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div>',
			widgetThinBorderWithBottom = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div style="border-bottom: 1px solid #DADADA;" id="resultsSearch" class="searchWidget"><form class="searchForm" style="background: #F2F2F2;" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true" data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div><div class="dividerBefore"></div>',
			widgetBasic100 = '<a href="javascript:didClickIcon = true;ATTMobileSearchWidget.runSearch();" style="text-indent: -999em;overflow: hidden;display: inline-block;" class="searchClick">Tap to search</a><div id="resultsSearch" class="searchWidget" style="background-color: #f2f2f2;"><form class="searchForm"  style="background-color: #f2f2f2;" id="subSearch" method="get" action="/mobilesearch/search-results.html?m_search=true" data-ajax="false"><div id="inp_wrap" class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-c ui-focus"><input title="search" role="combobox" aria-autocomplete="list" aria-owns="predicitonBucket" type="text" autocorrect="off" autocomplete="off" data-type="search" name="m_search" id="m_search" class="searchInput ui-input-text ui-body-c" placeholder="Search AT&amp;T" style="width: 100%;"><a href="#" id="clearSearchText" class="ui-input-clear ui-btn ui-btn-up-c ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div><div class="autoSearchVat" style="display: none;"><ul id="predicitonBucket" data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" class="ui-listview ui-listview-inset ui-corner-all ui-shadow"></ul></div></form></div>';
			...
			if (typeof CQURLInfo !== 'undefined') {
				...
				if (CQURLInfo.requestPath.indexOf('/content/att/shopmobile/en/wireless/devices/') !== -1 || CQURLInfo.requestPath.indexOf('/content/att/shopmobile/en/wireless/plans/') !== -1 || CQURLInfo.requestPath.indexOf('/content/att/shopmobile/en/wireless/services/') !== -1) {
					...
					if ($('.morelinks').length > 0) {
						...
						// If more than one link list present append to the last link list.
						if ($('.linklist').length > 1) {
							$(widgetBasic).appendTo($('.linklist')[$('.linklist').length - 1]);
						} else {
				...
				} else if (window.location.href.indexOf('newLogin.action') !== -1 || window.location.href.indexOf('newAccountSelection.action') !== -1 || window.location.href.indexOf('newPasscode.action') !== -1 || window.location.href.indexOf('newForgotpwd.action') !== -1) {
					// login page
					// no widget here
					...
					if (ATTMobileMenuShunt.getNativeCookie('accessDomain') === 'native') {
						...
						$('div').live('pageshow', function (event, ui) {
							...
							if (currentScreenSearchWidgetLength === 0) {
								if (currentScreen === 'wirelessContainer') {
									...
									$(widgetBasic).prependTo($('#content:visible'));
								}
							}
						});
						$("div").live("pagehide", function (event, ui) {
						...
						setTimeout(function () {
							...
							if ($('footer .searchForm').length === 0) {
								if ($.mobile.activePage.attr("id") === 'container') {
									if ($('#content .searchForm').length === 0) {
										$(widgetBasic).appendTo($('#content:visible'));
									}
								} else {
									$(widgetBasic).prependTo($('footer:visible'));
				...
				} else if (window.location.href.indexOf('/mf/') !== -1) {
					timmyTimer = setInterval(function () {
						if ($('footer').length > 0 && $('#m_search').length < 1) {
							$(widgetBasic).insertBefore($('footer'));
							clearInterval(timmyTimer);
						}
					}, 1000);
				} else {
		...
		if (hasDoneInjection) {
			$('.searchWidget').live('click', function () {
				if (!didClickIcon) {
					// scroll top so the user can see the previous/auto terms
					jQuery('html, body').animate({
						scrollTop: $('.searchWidget').offset().top
					}, 150);
					if (localStorage.getItem("prevSearches") !== null) {
						$('.autoSearchVat').slideDown(450, function () {
							sliderIsOpen = true;
							...
							if (localStorage.getItem("prevSearches") !== null && !loadedPrevSearches) {
								// Remove if any previous search <li> exists. Fix for HR1309M-269 (DSS issue of repeated previous search terms)
								$('#predicitonBucket').html('');
								p_vals = localStorage.getItem("prevSearches").split('|');
								for (i = 0; i < p_vals.length; i += 1) {
									if (i < 5) {
					...
					$('#subSearch').submit(function (e) {
						// Run search
						ATTMobileSearchWidget.runSearch();
						e.preventDefault();
					});
			...
			if (navigator.userAgent.indexOf('iPhone') !== -1) {
				setTimeout(function () {
					$('#resultsSearch').parent().css({'overflow': 'hidden'});
				}, 3000);
			}
		}
	};
