...
var ATTMobileMenuShunt = (function ($) {
	...
	init = function () {
		...
		//callRestService('http://141.204.55.103:8080/dev/sb3.1/global/assets3.1.0/css/slideMenu.css', 'css');
		...
		if (urlParams.nativeAppId && urlParams.nativeAppId !== '') {
			...
			if (ATTMobileMenuShunt.getNativeCookie() === 'native') {
				...
				$(document).ready(function () {
					...
					//ATTMobileMenuShunt.callRestService('http://141.204.55.103:8080/dev/sb3.1/global/assets3.1.0/css/slideMenu.css', 'css');
